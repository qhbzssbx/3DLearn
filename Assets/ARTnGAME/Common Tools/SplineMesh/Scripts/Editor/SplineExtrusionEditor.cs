...
namespace Artngame.SplineMesh {
    ...
    public class SplineExtrusionEditor : Editor {
        ...
        //v0.1
        private SerializedProperty startFlatProfile;
        private SerializedProperty forceReset;

        //v0.2
        private SerializedProperty isPrefab;
        ...
        private void OnEnable() {
            ...
            //v0.1
            startFlatProfile = serializedObject.FindProperty("startFlatProfile");
            forceReset = serializedObject.FindProperty("forceReset");

            //v0.2
            isPrefab = serializedObject.FindProperty("isPrefab");
        }
        ...
        public override void OnInspectorGUI() {
            ...
            {
                Undo.RegisterCompleteObjectUndo(se, "Reset Mesh");
                //se.shapeVertices.Remove(selection);
                // selection = null;
                se.SetToUpdate();
                se.Reset();
            ...
            //0.1
            EditorGUILayout.PropertyField(startFlatProfile, true);
            EditorGUILayout.PropertyField(forceReset, true);

            //v0.2
            EditorGUILayout.PropertyField(isPrefab, true);
