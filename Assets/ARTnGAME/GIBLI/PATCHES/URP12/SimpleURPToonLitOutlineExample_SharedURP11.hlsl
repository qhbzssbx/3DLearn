...
#include "SimpleURPToonLitOutlineExample_LightingEquationURP11.hlsl"

// this function contains no lighting logic, it just pass lighting results data around
half3 ShadeAllLights(SurfaceData surfaceData, LightingDataA lightingData)
{
    // Indirect lighting
