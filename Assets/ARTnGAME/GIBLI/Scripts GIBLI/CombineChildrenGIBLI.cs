...
{
    //[AddComponentMenu("Mesh/Combine Meshes GIBLI")]
    public class CombineChildrenGIBLI : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            for (int i = 0; i < filters.Length; i++)
            {
                ...
                MeshCombineUtilityGIBLI.MeshInstance instance = new MeshCombineUtilityGIBLI.MeshInstance();
            ...
            foreach (DictionaryEntry de in materialToMesh)
            {
                ...
                MeshCombineUtilityGIBLI.MeshInstance[] instances = (MeshCombineUtilityGIBLI.MeshInstance[])elements.ToArray(typeof(MeshCombineUtilityGIBLI.MeshInstance));
                ...
                if (materialToMesh.Count == 1)
                {
                    ...
                    filter.mesh = MeshCombineUtilityGIBLI.Combine(instances, generateTriangleStrips);
