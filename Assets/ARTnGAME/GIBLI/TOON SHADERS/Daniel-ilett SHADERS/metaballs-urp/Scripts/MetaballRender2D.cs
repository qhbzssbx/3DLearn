...
namespace Artngame.GIBLI.MetaBall2D
{
    public class MetaballRender2D : ScriptableRendererFeature
    {
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            pass.Setup(renderingData.cameraData.renderer.cameraColorTargetHandle);//renderer.cameraColorTarget);//v0.1
#else
            pass.Setup(renderer.cameraColorTarget);//v0.1
#endif
