...
HLSLINCLUDE
    ...
    half4 Frag_Contrast(VaryingsA input) : SV_Target
    {
    ...
    half4 Frag_Blur1(VaryingsA input) : SV_Target
    {
        half4 color = 0;
    ...
    half4 Frag_Blur2(VaryingsA input) : SV_Target
    {
        half4 color = 0;
    ...
    half4 Frag_Blend(VaryingsA input) : SV_Target
    {
        half4 color = SAMPLE_TEXTURE2D_X(_MainTex, sampler_LinearClamp , input.uv);
