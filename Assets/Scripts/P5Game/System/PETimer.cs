...
public class PETimer : ISingleton {
    ...
    public DateTime GetLocalDateTime() {
        ...
        // 计算目标时间
        DateTime targetDateTime = startDateTime.AddMilliseconds(nowTime);
        // 将 UTC 时间转换为本地时间
        DateTime localDateTime = TimeZoneInfo.ConvertTimeFromUtc(targetDateTime, TimeZoneInfo.Local);
